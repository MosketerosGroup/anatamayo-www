  ...
  return (
    <>
        ...
        <div className="flex flex-col items-center mt-8 gap-y-4 lg:flex-row">
          <div className="w-full lg:pr-8 lg:basis-1/2 xl:basis-5/12">
            <div className="flex flex-row items-center">
              ...
              <h1 className="font-beausite-regular text-right px-4 uppercase text-xl tracking-[0.25rem] md:text-5xl md:pl-4 lg:text-3xl lg:pr-12 lg:pl-8">
                Jaguar
              </h1>
            </div>
      ...
      <div className="mt-8 bg-base-200 py-8 relative">
        <div className="absolute font-beausite-regular text-primary/40 text-xl left-[5%] top-[50%] -translate-y-[50%] [writing-mode:_sideways-lr]">
          Gallery
        </div>
        <div className="box-container text-center">
          ...
          <p className="box-container mt-4 text-sm md:text-base">
            The jaguar, whose name comes from the Tupi and Guaraní word yaguareté (meaning “true ferocious beast”), is a
            symbol of power and nature's energy, often seen as a divine protector of the jungle.<br/>
            Major threats to jaguars include hunting and livestock farming, making ecological corridors essential for their survival.
          </p>
        </div>
      </div>
    </>
